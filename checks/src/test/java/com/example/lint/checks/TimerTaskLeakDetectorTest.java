...
public class TimerTaskLeakDetectorTest extends LintDetectorTest {
...
//                        "0 errors, 1 warnings\n");
    ...
    protected Detector getDetector() {
        return new TimerTaskLeakDetector();
    }

    @Override
    protected List<Issue> getIssues() {
        return Collections.singletonList(TimerTaskLeakDetector.ISSUE);
    }
}